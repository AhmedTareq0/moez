            ...
            <div class="messaging">
                <div class="inbox_msg">
                    <div class="inbox_people d-md-block d-lg-block ">
                        <div class="headind_srch d-flex p-2 align-items-center justify-content-between">
                            @if(request()->has('thread'))
                                <a class="btn btn-primary text-decoration-none" href="{{route('admin.messages')}}">
                                    <i class="icon-plus"></i><span class="mx-1">@lang('labels.backend.messages.compose')</span>
                                </a>
                            @endif
                            <div class="srch_bar @if(!request()->has('thread')) text-left @endif">
                                <div class="stylish-input-group">
                                    <input type="text" class="search-bar w-100" id="myInput" placeholder="@lang('labels.backend.messages.search_user')">
                                                ...
                                                <div class="chat_people">
                                                    ...
                                                    <div class="chat_ib">
                                                        <h5 class="position-relative">
                                                            <small class="text-info chat_date position-absolute">{{ $item->messages()->orderBy('id', 'desc')->first()->created_at->diffForHumans() }}</small>
