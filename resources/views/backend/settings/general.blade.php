                    ...
                    <div class="row mt-2 mb-4">
                        ...
                        <div class="col-lg-3 border-left col-12">
                            <div class="form-group input-list">
                                ...
                                <div class="checkbox">
                                    <label><input class="option" type="checkbox" data-name="country" data-type="select"
                                                  value=""> {{__('labels.backend.general_settings.user_registration_settings.fields.country')}}
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label><input class="option" type="checkbox" data-name="city" data-type="select"
...
//              e.preventDefault();
        ...
        $(document).on('click', '.input-list input[type="checkbox"]', function () {
            ...
            var textInputs = ['text', 'date', 'number' , 'select'];
            if ($(this).is(':checked')) {
        ...
        function appendElement(type, name) {
            ...
            if (textInputs.includes(type)) {
                ...
                html = "<div class='form-group'>" +
                    "<select  readonly data-name='" + name + "' class='form-control'>" +"<option selected>" + values[name] + "</option>"+ "</select>" +
