            ...
            <div class="form-group row">
                <div class="col-6 border-right">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <textarea id="location_on_map"
                                    class="form-control"
                                    rows="9"
                                    placeholder="{{ __('labels.backend.general_settings.contact.location_on_map') }}"
                                    name="location_on_map">{{ config('contact.location_on_map') }}</textarea>
                        </div>
                        <div class="col-md-12">
                            <p style="line-height: 35px">
                                <span class="mr-2">{{__('labels.backend.general_settings.contact.show')}}</span>
                                {{ html()->label(html()->checkbox('')->checked()->class('switch-input')->value(1)->checked() . '<span class="switch-label"></span><span class="switch-handle"></span>')
                              ->class('switch switch-sm switch-3d switch-primary')
                          }} </p>
                        </div>
                    </div>
