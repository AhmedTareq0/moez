            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    <div class="form-group row">
                        {!! Form::label('zoom__account_id', trans('labels.backend.zoom_setting.fields.account_id').'*', ['class' => 'col-md-2 form-control-label']) !!}
                        <div class="col-md-10">
                            {!! Form::text('zoom__account_id', config('zoom.account_id'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.zoom_setting.fields.api_key'), 'required' => 'true']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        {!! Form::label('zoom__client_id', trans('labels.backend.zoom_setting.fields.client_id').'*', ['class' => 'col-md-2 form-control-label']) !!}
                        <div class="col-md-10">
                            {!! Form::text('zoom__client_id', config('zoom.client_id'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.zoom_setting.fields.api_secret'), 'required' => true]) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        {!! Form::label('zoom__client_secret', trans('labels.backend.zoom_setting.fields.client_secret').'*', ['class' => 'col-md-2 form-control-label']) !!}
                        <div class="col-md-10">
                            {!! Form::text('zoom__client_secret', config('zoom.client_secret'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.zoom_setting.fields.api_secret'), 'required' => true]) !!}
                        </div>
                    </div>
                    {{-- <div class="form-group row">
