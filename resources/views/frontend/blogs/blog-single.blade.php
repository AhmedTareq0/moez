...
@section('content')
    ...
    <!-- Start of Blog single content
        ============================================= -->
    <section id="blog-detail" class="blog-details-section text-start">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="blog-comment-area ul-li about-teacher-2 text-start">
                            ...
                            @if(auth()->check())
                                <div class="teacher-faq-form">
                                    <form method="POST" action="{{route('blogs.comment',['id'=>$blog->id])}}"
                                        ...
                                        <div class="">
                                            <button class="btn btn-lg btn-primary" type="submit" value="Submit"> @lang('labels.frontend.blog.add_comment')</button>
                                        </div>
                                    </form>
                                </div>
                            @else
